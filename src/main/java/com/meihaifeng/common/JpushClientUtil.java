...
public class JpushClientUtil {
    ...
    private final static String appKey = "f4e4f37d6937ae0cd2f79284";//37885581@qq.com

    private final static String masterSecret = "b0976f80cd3d9a8fcf4dca0e";
    ...
    public static void main(String[] args){
        if(JpushClientUtil.sendToAllAndroid("推送标题","测试推送","this is a ios Dev test","")==1){
